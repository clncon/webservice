 ...
 * 2017-08-30T16:46:58.619+08:00
 * Generated source version: 3.1.12
 * 
 */
@WebServiceClient(name = "MobileCodeWS", 
                  wsdlLocation = "file:///E:/Users/wsimport/phoneService/MobileCodeWS.xml",
...
public class MobileCodeWS extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:///E:/Users/wsimport/phoneService/MobileCodeWS.xml");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(MobileCodeWS.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:///E:/Users/wsimport/phoneService/MobileCodeWS.xml");
        }
        WSDL_LOCATION = url;
    }
