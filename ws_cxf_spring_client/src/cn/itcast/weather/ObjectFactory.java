...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://weather.itcast.cn/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://weather.itcast.cn/", "queryWeatherResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://weather.itcast.cn/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://weather.itcast.cn/", name = "queryWeatherResponse")
