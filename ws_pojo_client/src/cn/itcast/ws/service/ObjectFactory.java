 ...
 * generated in the cn.itcast.ws.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://service.ws.itcast.cn/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://service.ws.itcast.cn/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.itcast.ws.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.itcast.cn/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.itcast.cn/", name = "queryWeather")
